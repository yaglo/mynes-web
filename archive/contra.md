...
For the gameplay presentation, see the [game showcase]({{ '/archive/showcase/' | relative_url }}) and [full-resolution gameplay / beam close-ups]({{ '/gallery/close-ups/' | relative_url }}). This page retains controlled diagnostic comparisons at their stated capture resolutions.
