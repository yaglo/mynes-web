...
For the current presentation, see the [game showcase]({{ '/archive/showcase/' | relative_url }}) and [full-resolution gameplay / beam close-ups]({{ '/gallery/close-ups/' | relative_url }}). This page retains controlled diagnostic comparisons at their stated capture resolutions.
...
<figure class="figure">
<a href="{{ '/assets/images/crt-contra-review.png' | relative_url }}"><img src="{{ '/assets/previews/crt-contra-review.webp' | relative_url }}" alt="Contra boss through the four current presets" width="1280" height="1024" loading="lazy"></a>
...
<figure class="figure">
<a href="{{ '/assets/images/crt-contra-native.png' | relative_url }}"><img src="{{ '/assets/previews/crt-contra-native.webp' | relative_url }}" alt="Native boss crops" width="1296" height="1728" loading="lazy"></a>
...
GPU regressions independently check neutral mask mean, nonnegative coverage, RGB/BGR order, resize behaviour, linear HDR handling, beam energy and gun-independent growth. The complex-IF GPU regression found maximum absolute decoded-gray noise correlation of 0.00632 at lags 1–12. Before the IF update, a separate 36-frame final-render gray-field test found no repeating peak (maximum absolute correlation 0.034). It removes the fixed image/mask by subtracting the temporal mean, which introduces a small negative bias. [Final-render metrics](https://github.com/yaglo/mynes/blob/master/docs/gpu-rf-temporal-results.json). Replaying the last saved legacy RF profile with all its controls retained also did not reproduce a several-frame cycle: adjacent-frame correlation decayed rather than returning at a periodic lag. This does not identify the exact texture reported by the user; deterministic composite crawl and mask structure must remain separate from random snow.

## Drawable size and connection checks

<figure class="figure">
<a href="{{ '/assets/images/crt-contra-window-native.png' | relative_url }}"><img src="{{ '/assets/previews/crt-contra-window-native.webp' | relative_url }}" alt="Native crops at a 1280×960 drawable" width="1280" height="1024" loading="lazy"></a>
<figcaption class="fig-note">Lossy WebP preview at the original 1280×1024 size. Open the image for the lossless PNG (1.4 MB).</figcaption>
</figure>
...
<figure class="figure">
<a href="{{ '/assets/images/crt-contra-inputs.png' | relative_url }}"><img src="{{ '/assets/images/crt-contra-inputs.png' | relative_url }}" alt="Same PVM, component, composite and external RF receiver" width="1920" height="512" loading="lazy"></a>
</figure>
...
<figure class="figure">
<a href="{{ '/assets/images/crt-preset-review.png' | relative_url }}"><img src="{{ '/assets/previews/crt-preset-review.webp' | relative_url }}" alt="Current four-profile Mario review" width="1280" height="1024" loading="lazy"></a>
<figcaption class="fig-note">Lossy WebP preview at the original 1280×1024 size. Open the image for the lossless PNG (1.3 MB).</figcaption>
</figure>

<figure class="figure">
<a href="{{ '/assets/images/crt-streak-review.png' | relative_url }}"><img src="{{ '/assets/images/crt-streak-review.png' | relative_url }}" alt="Current bright/dark recovery check" width="1280" height="1024" loading="lazy"></a>
</figure>
...
<figure class="figure">
<a href="{{ '/assets/images/gpu-osd-review.png' | relative_url }}"><img src="{{ '/assets/previews/gpu-osd-review.webp' | relative_url }}" alt="OSD review" width="1280" height="960" loading="lazy"></a>
<figcaption class="fig-note">Lossy WebP preview at the original 1280×960 size. Open the image for the lossless PNG (1.2 MB).</figcaption>
</figure>
...
<figure class="figure">
<a href="{{ '/assets/images/gpu-osd-adjustment.png' | relative_url }}"><img src="{{ '/assets/previews/gpu-osd-adjustment.webp' | relative_url }}" alt="Bottom-of-screen parameter adjustment" width="1280" height="960" loading="lazy"></a>
<figcaption class="fig-note">Lossy WebP preview at the original 1280×960 size. Open the image for the lossless PNG (1.2 MB).</figcaption>
</figure>
