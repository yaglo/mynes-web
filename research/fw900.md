---
layout: "page"
title: "Sony GDM-FW900 empirical monitor model"
permalink: "/research/fw900/"
section: "research"
description: "A separate 1920×1200 deposition path fitted to the NIDL FW900 report: what the data constrain and what they do not."
...
[`fw900_nidl.json`](https://github.com/yaglo/mynes/blob/master/tools/measurements/fw900_nidl.json).
...
[measurement notes]({{ '/research/measurements/' | relative_url }})); the preset therefore disables that
