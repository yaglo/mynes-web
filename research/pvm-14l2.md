...
The [partial SPICE deck](https://github.com/yaglo/mynes/blob/master/tools/circuits/pvm14l2_aperture_input.cir) and
[sweep](https://github.com/yaglo/mynes/blob/master/tools/circuits/sweep_pvm_aperture.py) isolate TP106-to-SHP-IN with
