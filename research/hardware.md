...
MC141627 algorithm. See [control semantics and HDR measurements](https://github.com/yaglo/mynes/blob/master/docs/gpu-controls.md).
...
The [KiCad sheet and ngspice sweep](https://github.com/yaglo/mynes/blob/master/tools/circuits/README.md) isolate the
